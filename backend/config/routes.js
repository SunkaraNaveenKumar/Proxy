...
router.get("/user/mycourses",authenticate,userController.getMyCourses)
router.get("/user/course/:courseId/lectures",authenticate,userController.getLectures)
...
router.get("/admin/course/:courseId/lectures",authenticate,authorizeUser(["admin"]), adminController.getLectures)
